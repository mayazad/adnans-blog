      ...
      <div className={styles.toolbar}>
        ...
        <div className={styles.toolbarGroup}>
          <button
            ...
            className={`${styles.toolbarBtn} ${editor.isActive({ textAlign: 'left' }) || (!editor.isActive({ textAlign: 'center' }) && !editor.isActive({ textAlign: 'right' }) && !editor.isActive({ textAlign: 'justify' })) ? styles.active : ''}`}
            title="Align Left"
          >
