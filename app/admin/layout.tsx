...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // Middleware should already protect this route, but we double-check session here
    ...
    <div className={styles.layout}>
      ...
      <aside className={styles.sidebar}>
        <div className={styles.brand}>
          <Link href="/admin">Adnan's Blog Admin</Link>
        </div>
        ...
        <div className={styles.bottomNav}>
          {profile?.username === 'mayazad' && (
            <Link href="/admin/vault" className={styles.link} style={{ color: 'var(--emerald-deep)', fontWeight: 500 }}>
